     ...
     .action(async (provider, opts) => {
          try {
               ...
               if (!fs.existsSync(packageJsonPath)) {
                    ...
                    throw new Error("Missing package.json - not a valid Node.js project directory");
               }
               ...
               if (env == null) {
                    throw new Error("Missing environment file (.env, .env.local, or database.env)");
               }
               ...
               const schema = opts.schema ? opts.schema : findFile(process.cwd(), "schema.prisma");
               if (schema == null) {
               ...
               if (prisma == null) {
                    ...
                    console.log("Prisma Client Manager generated successfully at lib/prisma.ts");
               } else {
                    console.log(`Your singleton Prisma Client instance is found at: ${prisma}`);
                    console.log("Skipping Prisma Client Manager generation - file already exists.");
               }
